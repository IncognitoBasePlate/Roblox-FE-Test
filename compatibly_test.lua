...
-- Auto Load Watheck's Utilites (Uncomment to enable (not required)
-- getgenv().Color3, getgenv().Instance, getgenv().math, getgenv().string, getgenv().table, getgenv().Watheck = (function()return loadstring(rawget(game:GetObjects[[rbxassetid://3554165973]], 0x1).Source)[[Pepsi Was]][[Here]]end)[[Pepsi Utilites]]
